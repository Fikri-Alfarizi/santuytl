...
@section('title', 'Kick User Discord')
@section('content')
<div class="container">
    <h2>Kick User dari Server Discord</h2>
    <form method="POST" action="{{ route('admin.discord.kick') }}">
        @csrf
        ...
        <button type="submit" class="btn btn-danger">Kick User</button>
    </form>
</div>
